...
--]]
function splay.check_ports(port_min, port_max)
...
function splay.release_ports(min, max)
...
--]]
function splay.reserve_ports(min, max)
...
function splay.dir_writable(dir)
